...
parser.add_argument("--data_prefix",default="/home/huixin/PycharmProjects/GCNP/data/ogbn-arxiv_undirected",type=str,help="prefix identifying training data")
...
parser.add_argument("--train_config",default="/home/huixin/PycharmProjects/GCNP/train_config/fullbatch/flickr_2x.yml",type=str,help="path to the configuration of training (*.yml)")
...
parser.add_argument("--cpu_eval", default=True, action="store_true", help="whether to use CPU to do evaluation")
parser.add_argument("--minibatch_eval",default=False, action="store_true", help="whether to use minibatch to do evaluation")
parser.add_argument("--cpu_prune", default=True, action="store_true", help="whether to use CPU to do pruning")
